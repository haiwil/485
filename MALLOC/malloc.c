...
#define MEM1_MAX_SIZE			2*1024  						//最大管理内存 100K
#define MEM1_ALLOC_TABLE_SIZE	MEM1_MAX_SIZE/MEM1_BLOCK_SIZE 	//内存表大小


//定时器事件链表专用
//mem2内存参数设定.mem2处于内部SRAM里面.
#define MEM2_BLOCK_SIZE			16  	  						//内存块大小为32字节
#define MEM2_MAX_SIZE			1*1024  						//最大管理内存10K
#define MEM2_ALLOC_TABLE_SIZE	MEM2_MAX_SIZE/MEM2_BLOCK_SIZE 	//内存表大小

		 
//内存池(32字节对齐)
__align(32) u8 mem1base[MEM1_MAX_SIZE];										//内部SRAM内存池
__align(32) u8 mem2base[MEM2_MAX_SIZE]; 									//内部SRAM内存池
...
{
	return my_mem_perused(SRAMIN2);//显示内部内存使用率
}
...
{  
    return mymalloc(SRAMIN2,size);
}

/*......................................................................*/
//消息链表，临时存包链表(此部分SRAM仅仅CPU可以访问!!!)
...
{
	return my_mem_perused(SRAMIN1);//显示内部内存使用率
}
